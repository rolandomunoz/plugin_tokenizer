...
form Tokenize tier
  ...
  text tg_folder_path <tg_folder_path>
  boolean Recursive_search <recursive_search>
  comment Tokenize TextGrid:
  word Input_tier <input_tier>
  boolean Add_segment_tier <add_segment_tier>
  boolean Add_syllable_tier <add_syllable_tier>
  boolean Add_word_tier <add_word_tier>
endform
